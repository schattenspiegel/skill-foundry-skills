# Python typing verification matrix

        | Scenario | Required evidence | Recipe |
        |---|---|---|
        | `structural-reader-protocol` | success + edge/failure path | `typing.verify-protocol-implementation` |
| `paramspec-decorator` | success + edge/failure path | `typing.verify-decorator-signature` |
| `typeis-mapping-narrower` | success + edge/failure path | `typing.verify-bidirectional-narrowing` |
